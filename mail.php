...
try {
    ...
    $mail->Username   = '';                                     // SMTP username - GMAIL USERNAME HERE
    $mail->Password   = '';                    // SMTP password - GMAIL PASSWORD HERE
    $mail->SMTPSecure = 'ssl';                                  // Enable TLS encryption, `ssl` also accepted
    $mail->Port       = 465;                                    // TCP port to connect to

    //Recipients
    $mail->setFrom('send-from-above-account', 'Mailer');
    $mail->addAddress('to-adress');     // Add a recipient
